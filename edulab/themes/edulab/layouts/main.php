...
/**   
INI YANG BIKIN NOTY ERROR DI FIREBUG
*/
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = Html::a('Login', ['/edulab/edulab/login'], ['class'=>'btn-menu-transparent btn-success']);
      ...
      $userreward = ProfileExtended::find()
       ->andWhere(['user_id' => Yii::$app->user->id])
...
.Html::a(Yii::t('app', 'Belajar'), [''], ['class'=>'dropdown-toggle', 'data-toggle'=>'dropdown']) .
       '<ul class="dropdown-menu">
           <li>
'.Html::a(Yii::t('app', 'Download Materi'), ['/edulab/edulab/materi'], ['class'=>'']) .'
           </li>
           <li>
'.Html::a(Yii::t('app', 'Download Bank Soal'), ['/edulab/edulab/soal'], ['class'=>'']) .'
           </li>
           <li>
'.Html::a(Yii::t('app', 'Video'), ['/edulab/edulab/video'], ['class'=>'']) .'
              ...
              <li class="divider"></li>
           <li>
'.Html::a(Yii::t('app', 'Latihan Soal Interaktif'), ['/edulab/edulab/exercise'], ['class'=>'']) .'
           </li>
           <li>
'.Html::a(Yii::t('app', 'Kelas Interaktif'), ['/edulab/edulab/course'], ['class'=>'']) .'
           </li>
...
.Html::a(Yii::t('app', 'Ujian'), [''], ['class'=>'dropdown-toggle', 'data-toggle'=>'dropdown']) .
       '<ul class="dropdown-menu">
           <li>
'.Html::a(Yii::t('app', '<span class="glyphicon glyphicon-star-empty"></span> Ujian Tryout'), ['/edulab/edulab/assessment'], ['class'=>'']) .'
           </li>
              <li class="divider"></li>
           <li>
'.Html::a(Yii::t('app', 'Hasil & Laporan'), ['/edulab/edulab/report'], ['class'=>'']) .'
           </li>
         </ul>
   </li>';
                   $menuItems[] = ['label' => Yii::t('app', 'Diskusi'), 'url' => ['/forum']];
...
.Html::a(Yii::t('app', '<span class="glyphicon glyphicon-user" aria-hidden="true"></span> (' . Yii::$app->user->identity->username . ' / '.Yii::$app->user->id.')<b class="caret"></b>'), ['/edulab/profile/profile'], ['class'=>'dropdown-toggle', 'data-toggle'=>'dropdown']) .
       '<ul class="dropdown-menu">
           <li>
'.Html::a(Yii::t('app', '<span class="glyphicon glyphicon-usd" aria-hidden="true"></span> eduCredit (' . $creditpoint . ')'), ['/edulab/credit/index'], ['class'=>'']) .'
           </li>
           <li>
'.Html::a(Yii::t('app', '<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> eduReward (' . $rewardpoint . ')'), ['/edulab/edulab/reward'], ['class'=>'']) .'
           </li>
           <li>
'.Html::a(Yii::t('app', 'Profile'), ['/edulab/profile/profile'], ['class'=>'']) .'
                      ...
                      <li class="divider"></li>
                                 <li>
'.Html::a(Yii::t('app', 'Bakat & Minat'), ['/edulab/edulab/bakatminat'], ['class'=>'']) .'
           </li>
                      <li class="divider"></li>
           <li>
'.Html::a(Yii::t('app', 'Help'), ['/edulab/edulab/help'], ['class'=>'']) .'
           </li>
                       <li>
