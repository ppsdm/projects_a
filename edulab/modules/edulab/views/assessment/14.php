...
$new_result->value = strval($tpa_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->value = strval($tpa_kosong);
$new_result->insert();
...
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
$new_result->value = strval($bind_salah);
$new_result->attribute_1 = 'incorrect';
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
...
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
$new_result->value = strval($bind_kosong);
$new_result->attribute_1 = 'unanswered';
$new_result->insert();
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'incorrect';
$new_result->value = strval($bing_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'unanswered';
$new_result->value = strval($bing_kosong);
$new_result->insert();

$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
$new_result->type = 'biologi';
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'incorrect';
$new_result->value = strval($biologi_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'unanswered';
$new_result->value = strval($biologi_kosong);
$new_result->insert();

$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
$new_result->type = 'fisika';
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');

$new_result->value = strval($fisika_betul);
$new_result->attribute_1 = 'correct';
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
...
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
$new_result->value = strval($fisika_salah);
$new_result->attribute_1 = 'incorrect';
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
...
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
$new_result->value = strval($fisika_kosong);
$new_result->attribute_1 = 'unanswered';
$new_result->insert();
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'incorrect';
$new_result->value = strval($kimia_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'unanswered';
$new_result->value = strval($kimia_kosong);
$new_result->insert();
...
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
$new_result->type = 'matematika_dasar';
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'incorrect';
$new_result->value = strval($mtk_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'unanswered';
$new_result->value = strval($mtk_kosong);
$new_result->insert();

$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
$new_result->type = 'matematika_ipa';
$new_result->status = 'current';
$new_result->created_at = new Expression('NOW()');
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'incorrect';
$new_result->value = strval($ekonomi_salah);
$new_result->insert();
$new_result = new Result();
$new_result->assessment_id = $assessment_result->assessment_id;
$new_result->catalog_id = $catalog_id;
...
$new_result->created_at = new Expression('NOW()');
$new_result->attribute_1 = 'unanswered';
$new_result->value = strval($ekonomi_kosong);
$new_result->insert();
...
foreach ($institution_targets as $institution_target) {
  ...
  if (($total_betul / ($total_betul + $total_salah + $total_kosong) * 100) >= $pref->value) {
