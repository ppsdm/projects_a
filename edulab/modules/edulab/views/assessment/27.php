          ...
          'options' => [
              ...
              'series' => [
                  ...
                  [
                      'type' => 'column',
                      'name' => 'Average',
                      'data' => [round($average_score_array[$catalog_id]['geografi']['sum'] / (($average_score_array[$catalog_id]['geografi']['count']  > 0 ) ? $average_score_array[$catalog_id]['geografi']['count'] : 1) * 100 / 15), 
