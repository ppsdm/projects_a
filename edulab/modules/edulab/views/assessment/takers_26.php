...
foreach ($results as $result_key => $result_value) {
    ...
    array_push($columns,
                    ...
                    'value' => function($data) use ($tpatotal){
                        ...
                        return isset($tpatotal[$data->id]) ? $tpatotal[$data->id] .'' : '0';
                    }]);
    ...
    array_push($columns,
                    ...
                    'value' => function($data) use ($tpa_incorrect_total){
                        ...
                        return isset($tpa_incorrect_total[$data->id]) ? $tpa_incorrect_total[$data->id] .'' : '0';
                    }]);
        array_push($columns,
                    [
                    'label' => 'tpa kosong',
                    ...
                    'value' => function($data) use ($tpatotal, $tpa_incorrect_total){
                        ...
                        return isset($tpatotal[$data->id]) ? (45 - ($tpatotal[$data->id] + $tpa_incorrect_total[$data->id])) .'' : '0';
                    }]);
            array_push($columns,
                    [
                    'label' => 'tpa poin',
            ...
            'attribute' => 'resultsum',
            'value' => function($data) {
                return number_format($data->resultsum/150 * 100,2);
            }
         ]);
