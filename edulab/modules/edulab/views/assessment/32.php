...
$score_array = [];
$average_score_array = [];
$matpel_array = ['','matematika_ipa', 'fisika', 'kimia', 'biologi', 'matematika_dasar', 'bahasa_indonesia', 'bahasa_inggris', 'tpa_1', 'tpa_2', 'tpa_3'];
$index9 = 0;
...
<div class="row">
  ...
  //echo $tpa_c;
          ...
          'options' => [
              ...
              'xAxis' => [
                  'categories' => ['Matematika IPA','Fisika', 'Kimia', 'Biologi', 'Matematika Dasar', 'B.Indonesia', 'B.Inggris', 'TPA'],
              ],
              'yAxis' => [
              ...
              'series' => [
                  ...
                  [
                      ...
                      'data' => [$mtkipa_c, $fisika_c, $kimia_c, $biologi_c, $mtk_c, $bind_c, $bing_c, $tpa_c],
                  ],
                  [
                      'type' => 'column',
                      'name' => 'Average',
                      
                      'data' => [round($average_score_array[$catalog_id]['matematika_ipa']['sum'] / (($average_score_array[$catalog_id]['matematika_ipa']['count']  > 0 ) ? $average_score_array[$catalog_id]['matematika_ipa']['count'] : 1) * 100 / 15), 
                      round($average_score_array[$catalog_id]['fisika']['sum'] / (($average_score_array[$catalog_id]['fisika']['count'] > 0) ? $average_score_array[$catalog_id]['fisika']['count'] : 1 )* 100 / 15), 
round($average_score_array[$catalog_id]['kimia']['sum'] / (($average_score_array[$catalog_id]['kimia']['count'] > 0) ? $average_score_array[$catalog_id]['kimia']['count'] : 1 ) * 100 / 15), 
round($average_score_array[$catalog_id]['biologi']['sum'] / (($average_score_array[$catalog_id]['biologi']['count'] > 0) ? $average_score_array[$catalog_id]['biologi']['count'] : 1 )* 100 / 15), 
