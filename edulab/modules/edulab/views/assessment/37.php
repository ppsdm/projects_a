...
$score_array = [];
$average_score_array = [];
$matpel_array = ['','geografi', 'ekonomi', 'sosiologi', 'sejarah', 'matematika_dasar', 'bahasa_indonesia', 'bahasa_inggris', 'tpa_1', 'tpa_2', 'tpa_3'];
$index9 = 0;
...
$c_unanswered =  (isset($score_array[$matpel_index]['unanswered'])) ? strval($score_array[$matpel_index]['unanswered']) : 0;
      ...
      $total_betul = $total_betul + $c_correct;
      $total_salah = $total_salah + $c_incorrect;
      $total_kosong = $total_kosong + $c_unanswered;
}
$matpel_index++;
...
<div class="row">
  ...
  $geografi_c =($score_array[1]['correct'] + $score_array[1]['incorrect'] + $score_array[1]['unanswered']) > 0 ? round($score_array[1]['correct'] / 
                      ($score_array[1]['correct'] + $score_array[1]['incorrect'] + $score_array[1]['unanswered']) * 100) : 0;;
  $ekonomi_c = ($score_array[2]['correct'] + $score_array[2]['incorrect'] + $score_array[2]['unanswered']) > 0 ? round($score_array[2]['correct'] / 
                        ($score_array[2]['correct'] + $score_array[2]['incorrect'] + $score_array[2]['unanswered']) * 100) : 0;
  $sosiologi_c = ($score_array[3]['correct'] + $score_array[3]['incorrect'] + $score_array[3]['unanswered']) > 0 ? round($score_array[3]['correct'] / 
                        ($score_array[3]['correct'] + $score_array[3]['incorrect'] + $score_array[3]['unanswered']) * 100) : 0;
  $sejarah_c = ($score_array[4]['correct'] + $score_array[4]['incorrect'] + $score_array[4]['unanswered']) > 0 ? round($score_array[4]['correct'] / 
  ...
  //echo $tpa_c;
          ...
          'options' => [
              ...
              'xAxis' => [
                  'categories' => ['Geografi','Ekonomi', 'Sosiologi', 'Sejarah', 'Matematika Dasar', 'B.Indonesia', 'B.Inggris', 'TPA'],
              ],
              'yAxis' => [
              ...
              'series' => [
                  ...
                  [
                      ...
                      'data' => [$geografi_c, $ekonomi_c, $sosiologi_c, $sejarah_c, $mtk_c, $bind_c, $bing_c, $tpa_c],
                  ],
                  [
                      'type' => 'column',
                      'name' => 'Average',
...
round($average_score_array[$catalog_id]['geografi']['sum'] / (($average_score_array[$catalog_id]['geografi']['count']  > 0 ) ? $average_score_array[$catalog_id]['geografi']['count'] : 1) * 100 / 15), 
round($average_score_array[$catalog_id]['ekonomi']['sum'] / (($average_score_array[$catalog_id]['ekonomi']['count'] > 0) ? $average_score_array[$catalog_id]['ekonomi']['count'] : 1 )* 100 / 15), 
round($average_score_array[$catalog_id]['sosiologi']['sum'] / (($average_score_array[$catalog_id]['sosiologi']['count'] > 0) ? $average_score_array[$catalog_id]['sosiologi']['count'] : 1 ) * 100 / 15), 
round($average_score_array[$catalog_id]['sejarah']['sum'] / (($average_score_array[$catalog_id]['sejarah']['count'] > 0) ? $average_score_array[$catalog_id]['sejarah']['count'] : 1 )* 100 / 15), 
