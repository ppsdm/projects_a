...
$catalog_item_list = ['28','31','34','38', '53'];
...
echo Highcharts::widget([
  ...
  'data' => [
                            ...
                            isset($user_total_array['28']) ? round($user_total_array['28']/ ( $jumlah_soal) * 100) : 0, 
                            isset($user_total_array['31']) ? round($user_total_array['31']/ ( $jumlah_soal) * 100) : 0,
                            isset($user_total_array['34']) ? round($user_total_array['34']/ ( $jumlah_soal) * 100) : 0, 
                            isset($user_total_array['38']) ? round($user_total_array['38']/ ( $jumlah_soal) * 100) : 0,  
                            isset($user_total_array['53']) ? round($user_total_array['53']/ ( $jumlah_soal) * 100) : 0,  
  ...
  'data' => [
                            ...
                            isset($total_array['53']['sum']) ? round($total_array['53']['sum'] / ($total_array['53']['count'] * 15) * 100) : 0, 
...
echo Highcharts::widget([
  ...
  'data' => [
                            ...
                            isset($user_score_array['53'][$matpel_key]) ? round($user_score_array['53'][$matpel_key] * 100 / 15) : 0, 
  ...
  isset($score_array['53'][$matpel_key]['sum']) ? round($score_array['53'][$matpel_key]['sum'] / ($score_array['53'][$matpel_key]['count'] ? $score_array['53'][$matpel_key]['count'] : 1) * 100 / 15) : 0, 
...
echo "</div>";
  ...
  $increment5 = isset($user_score_array['53'][$matpel_key]) ? $user_score_array['53'][$matpel_key] : 0;
  ...
  $tpa_total['53'] = $tpa_total['53'] + $increment5;
...
$increment55 = isset($score_array['53'][$matpel_key]['sum']) ? $score_array['53'][$matpel_key]['sum'] / ($score_array['53'][$matpel_key]['count'] ? $score_array['53'][$matpel_key]['count'] : 1) : 0;
    ...
    $tpa_average_total['53'] = $tpa_average_total['53'] + $increment55;
}
        ...
        'series' => [
            ...
            [
                ...
                'data' => [
                         ...
                         round($tpa_total['28'] * 100/45), round($tpa_total['31'] * 100/45), round($tpa_total['34'] * 100/45), round($tpa_total['38'] * 100/45),round($tpa_total['53'] * 100/45),
            ...
            [
                ...
                'name' => 'Average',
                'data' => [
   round($tpa_average_total['28'] * 100/45),   round($tpa_average_total['31'] * 100/45),   round($tpa_average_total['34'] * 100/45),   round($tpa_average_total['38'] * 100/45), round($tpa_average_total['53'] * 100/45),
