...
$increment3 = isset($score_array['26'][$matpel_key]['sum']) ? $score_array['26'][$matpel_key]['sum'] / ($score_array['26'][$matpel_key]['count'] ? $score_array['26'][$matpel_key]['count'] : 1)  : 0;
$increment4 = isset($score_array['29'][$matpel_key]['sum']) ? $score_array['29'][$matpel_key]['sum'] / ($score_array['29'][$matpel_key]['count'] ? $score_array['29'][$matpel_key]['count'] : 1) : 0;
    $tpa_average_total['26'] = $tpa_average_total['26'] + $increment3;
    $tpa_average_total['29'] = $tpa_average_total['29'] + $increment4;
}
...
echo Highcharts::widget([
  ...
  'data' => [
                         ...
                         round($tpa_total['26'] * 100/45), round($tpa_total['29'] * 100/45),
            ...
            [
                ...
                'name' => 'Average',
                'data' => [
   round($tpa_average_total['26'] * 100/45),   round($tpa_average_total['29'] * 100/45),
