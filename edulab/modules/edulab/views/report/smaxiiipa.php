...
//                            isset($user_total_array['31']) ? round($user_total_array['31']/ ( 14 * 15) * 100) : 0, 
  ...
  'data' => [
                            ...
                            isset($total_array['32']['sum']) ? round($total_array['29']['sum'] / ($total_array['32']['count'] * 15) * 100) : 0, 
                            isset($total_array['36']['sum']) ? round($total_array['29']['sum'] / ($total_array['36']['count'] * 15) * 100) : 0,  
        ...
        'series' => [
            ...
            [
                ...
                'data' => [
                         ...
                         round($tpa_total['26'] * 100/45), round($tpa_total['29'] * 100/45), round($tpa_total['32'] * 100/45), round($tpa_total['36'] * 100/45),
            ...
            [
                ...
                'name' => 'Average',
                'data' => [
   round($tpa_average_total['26'] * 100/45),   round($tpa_average_total['29'] * 100/45),   round($tpa_average_total['32'] * 100/45),   round($tpa_average_total['36'] * 100/45),
