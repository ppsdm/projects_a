...
&lt;/select&gt;
              ...
              <li>
                <p>
                  ...
                  also pulling Font Awesome icons from CDN. 
                </p>
        ...
        <div class="configuration" id="nav-configuration">
          ...
          <div class="instructions">
            ...
            <p>
              ...
              Specify initial rating by passing select field's option value. If null, the plugin will try to set the initial rating by finding an option with a `selected` attribute.
            </p>
            <p>
        ...
        <div class="callbacks" id="nav-callbacks">
          ...
          <div class="instructions">
            <p>
              ...
              <small>Notice: If the rating was set programmatically by using the `set` method event will be null.</small>
            </p>
            <p>
          ...
          <div class="instructions">
            <div  class="question">
              ...
              <p>
                ...
                the theme in use). The select field will get hidden and a rating widget
...
&lt;/div&gt;
            ...
            <div class="question">
              ...
              <p>
                To allow users to select empty ratings simply include an empty
                option in your select field:
              </p>
