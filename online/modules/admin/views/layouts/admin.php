...
$menuItems[] = '<li class="dropdown" style="list-style:none;">' . Html::a(Yii::t('app', 'Lowongan'), ['/admin/jobs/index'], ['class'=>'']) . '</li>';
$menuItems[] = '<li class="dropdown" style="list-style:none;">' . Html::a(Yii::t('app', 'Pelamar'), ['/admin/applications/index'], ['class'=>'']) . '</li>';
$menuItems[] = '<li class="dropdown" style="list-style:none;">' . Html::a(Yii::t('app', 'Catalog'), ['/admin/catalog/index'], ['class'=>'']) . '</li>';
...
'.Html::a(Yii::t('app', '*Report Bug'), ['/site/bugreport'], ['class'=>'']) .'
            ...
            <li class="divider"></li>
                        ...
                        <li>
'.Html::a(Yii::t('app', 'Back to User site'), ['/cats/cats/index'], ['class'=>'']) . '
            </li>
