...
if ($objectPrint['profile_meta']['work']['level'] == 'PENGAWAS') { $eselon = 'ESELON4';}
else if ($objectPrint['profile_meta']['work']['level'] == 'ADMINISTRATOR') { $eselon = 'ESELON3';}
else { $eselon = 'ESELON2';}
...
<article>
 ...
 <div style="font-size: 18pt;position:absolute;left: 50%;top: 690px;transform: translateX(-50%);"><b>
 
 <?php 
if ($tanggal_test =='30/10/2017  8:00'){ 
	echo '30 Oktober - 1 November 2017';
} else {
 echo $day.' - '.$newDateSignature;
}
?>
...
<tbody>
<tr>
<td>Nomor Test</td><td>:</td><td><?=$nomor_test;?>/EVAL/<?=$eselon;?>/KEMENKES/<?=$tanggaltest;?>/<?=$array_bulan[$month];?>/<?=$year;?> </td></tr>
<tr>
...
<tr>
<td>Satuan Kerja</td><td>:</td><td><?=$objectPrint['profile_meta']['work']['satuan_kerja']; ?></td></tr>
<tr>
