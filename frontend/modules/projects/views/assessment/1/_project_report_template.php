...
[
  ...
  [
    ...
    'value' => function($data){
        ...
        $deskripsi_aspek = isset($deskripsi->attribute_1) ? $deskripsi->attribute_1 : ' belum ada deskripsi untuk ' . $data->key;
        return $deskripsi_aspek;
    },
    'contentOptions' => ['style'=>'white-space: normal;'],
  ],
  [
    ...
    'value' => function($data){
        ...
        ->andWhere(['key' => 'aspek'])
        ->andWhere(['value' => $data->key])->One();
        $deskripsi_aspek = isset($deskripsi->attribute_2) ? $deskripsi->attribute_2 : ' belum ada keterangan untuk ' . $data->key;
        return $deskripsi_aspek;
    },
      ...
      //  $saran_pengembangan = new AssessmentReport();
        ...
        if (null !== $saran_pengembangan_model) {
                  ...
                  foreach ($hasil_kompetensi as $key_kompetensi2 => $value_kompetensi2) {
                      ...
                      //echo $value_kompetensi2->key;
                      //echo 'reno<br/>';
                      $gap = $gh->attribute_1 - $value_kompetensi2->value;

                      // print_r($gh->attribute_1); die();
