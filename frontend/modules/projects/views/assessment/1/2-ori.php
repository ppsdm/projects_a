...
height = Math.min(width, window.innerHeight - margin.top - margin.bottom - 20);
    ...
    var data = [
      [
        ...
        {axis:'',value:".$result_object['kompetensigram']['bst']['lkj']."},
        {axis:'',value:".$result_object['kompetensigram']['ban']['lkj']."},
        {axis:'',value:".$result_object['kompetensigram']['bku']['lkj']."},
        {axis:'',value:".$result_object['kompetensigram']['kto']['lkj']."},      
        ...
        {axis:'',value:".$result_object['kompetensigram']['bst']['lki']."},
        {axis:'',value:".$result_object['kompetensigram']['ban']['lki']."},
        {axis:'',value:".$result_object['kompetensigram']['bku']['lki']."},
        {axis:'',value:".$result_object['kompetensigram']['kto']['lki']."},      
