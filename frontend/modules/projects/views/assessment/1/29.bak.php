...
height = Math.min(width, window.innerHeight - margin.top - margin.bottom - 20);
    ...
    var data = [
      [
        ...
        {axis:'',value:".$result_object['kompetensigram']['pfs']['lkj']."},
        {axis:'',value:".$result_object['kompetensigram']['ban']['lkj']."},
        ...
        {axis:'',value:".$result_object['kompetensigram']['pfs']['lki']."},
        {axis:'',value:".$result_object['kompetensigram']['ban']['lki']."},
...
?>
    ...
    <?= $form->field($assessment_report, 'executive_summary')->textArea(['rows' => 10, 'readonly'=> $readonly])->hint('min 500 chars, max 1100 chars') ?>
<?= $form->field($assessment_report, 'kekuatan')->textArea(['rows' => 10, 'readonly'=> $readonly])->hint('min 500 chars, max 1100 chars') ?>

<?= $form->field($assessment_report, 'saran_pengembangan')->textArea(['rows' => 10, 'readonly'=> $readonly])->hint('min 500 chars, max 1100 chars') ?>
