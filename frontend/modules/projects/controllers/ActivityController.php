...
class ActivityController extends Controller
{
 ...
 public function Actions()
 {
  ...
  public function actionNinecell($id)
  {                
    $searchModel = new ProjectActivitySearch();
    $params = Yii::$app->request->queryParams;
    $dataProvider = $searchModel->search($params);

    return $this->render('ninecell', [
        'searchModel' => $searchModel,
        'dataProvider' => $dataProvider,
    ]);        
  }    
...
$result_object['psikogram'][$psivalue->key]['lkj'] = $y->attribute_1;
    ...
    public function actionPdf($id)
    {
        ...
        */
        ...
        $tanggal_test = ProjectActivityMeta::find()->andWhere(['project_activity_id' =>$id])->andWhere(['type' => 'schedule'])
        ->andWhere(['key' => 'scheduled'])->One();

        $result_object['tanggal_test'] = $tanggal_test->value;
